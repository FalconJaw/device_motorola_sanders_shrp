...
BOARD_MKBOOTIMG_ARGS := --ramdisk_offset 0x01000000 --tags_offset 0x00000100 --dt device/motorola/sanders/prebuilt/dt.img
...
# SHRP Configuration
SHRP_PATH := device/motorola/sanders
SHRP_MAINTAINER := FalconJaw
SHRP_DEVICE_CODE := sanders
SHRP_EDL_MODE := 1
